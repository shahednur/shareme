    ...
    <div className="flex xl-flex-row flex-col m-auto bg-white" style={{maxWidth:'1500px',borderRadius:'32px'}}>
      ...
      <div className="w-full p-5 flex-1 xl:min-w-629">
        <div className="flex items-center justify-between">
          ...
          <a href={pinDetail.destination} target="_blank" rel="noreferrer" className="text-sm text-gray-600">
            {pinDetail.destination.length > 30 ? pinDetail.destination.substring(0, 30) + '...' : pinDetail.destination}
          </a>
        </div>
        <div>
        ...
        <Link  to={`user-profile/${pinDetail.postedBy?._id}`} className="flex gap-2 mt-5 items-center bg-white rounded-lg" >
          ...
          <div className="flex flex-wrap mt-6 gap-3">
            ...
            <input
                ...
                className="flex-1 border-gray-300 outline-none border-2 p-2 rounded-2xl focus:border-gray-300"
              />
              <button 
                type="button"
